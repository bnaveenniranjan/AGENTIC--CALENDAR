...
function SignInPage(){
    return <main className="app-shell-bg flex min-h-svh items-center justify-center px-6 py-10 ">
    <Card className="w-full max-w-md border-border/70 bg-card/90 shadow-none ring-1 ring-border/50">
        <CardHeader className="items-center text-center">
            ...
            <CardTitle className="font-heading text-3xl font-semibold tracking-tig">
                Meeting Assistant
            </CardTitle>
